...
const Support = () => {
    ...
    return (
        <>
            ...
            <StyledParentCard>
                <StyledCard color="#515197" onClick={() => window.open(links.kofi, '_blank')}>
                    <div className='cardTitle'>Donation</div>
                    <div className='cardDesc'>Not required or expected, but always appreciated!</div>
                    <div className='styledImg'>
                        <Image src="/assets/kofi.png" height={300} width={600} />
                    </div>
                </StyledCard>
                <StyledCard color="#51DB46" onClick={() => window.open(links.github, '_blank')}>
                    <div className='cardTitle'>Contribute</div>
                    <div className='cardDesc'>Join other developers to make this site more amazing!!</div>
                    <div className='styledImg'>
                        <Image src="/assets/github.png" height={300} width={600} />
                    </div>
                </StyledCard>
            </StyledParentCard>
            <StyledCard color="#53C0D1" onClick={() => window.open(links.share, '_blank')}>
                <div className='cardTitle'>Share</div>
                <div className='cardDesc'>Share across social media or with a friend who needs it </div>
                <div className='styledImg'>
